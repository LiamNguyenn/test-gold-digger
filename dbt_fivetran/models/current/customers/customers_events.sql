...
with
  all_events as (
    select
        ...
        , {{ try_cast("user_id", 'int') }} as numeric_user_id
        ...
        , {{ try_cast("organisation_id", 'int') }} as organisation_id
        ...
        , {{ try_cast("kp_employee_id", 'int') }} as kp_employee_id
        , {{ try_cast("kp_business_id", 'int') }} as kp_business_id
