...
where mp.name in ('Smart Match - Candidate shortlisted from talent prompt', 'Smart Match - Candidate added to new job', 'Smart Match - Candidate shortlisted to existing job')
